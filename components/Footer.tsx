...
const Footer = () => {
  return (
    <div>
      <footer className="text-gray-600 mt-5 border-t body-font">
        <div className="container sm:px-16 px-6 py-10 mx-auto">
          <div className="flex flex-wrap md:text-left text-center order-first">
            ...
            <div className="lg:w-1/4 md:w-1/2 w-full px-4">
              ...
              <nav className="list-none mb-10">
                <li>
                  <a className="text-gray-600 hover:text-gray-800">Event</a>
                </li>
                <li>
